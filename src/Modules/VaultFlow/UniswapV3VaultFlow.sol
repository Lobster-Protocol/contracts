...
contract UniswapV3VaultFlow is IVaultFlowModule, INav {
        ...
        returns (bool success)
    {
        ...
        uint256 valueToWithdraw0 =
            initialToken0Balance.mulDiv(sharesRatioBp, BASIS_POINT_SCALE) + (totalToWithdraw0 - feeCut0);
        uint256 valueToWithdraw1 =
            initialToken1Balance.mulDiv(sharesRatioBp, BASIS_POINT_SCALE) + (totalToWithdraw1 - feeCut1);
