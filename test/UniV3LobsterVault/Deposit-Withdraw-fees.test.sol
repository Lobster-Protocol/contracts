...
contract UniV3LobsterVaultDepositMintWithdrawRedeemFeesTest is UniV3LobsterVaultFeesSetup {
    ...
    function testWithdrawWithPositionFees() public {
    ...
    function testRedeemNoPositionFees() public {
        uint256 sharesToMint = 1 ether;
    ...
    function testRedeemWithPositionFees() public {
