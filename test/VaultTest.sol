...
// todo: add mint, withdraw and redeem without rebase tests
...
contract VaultTest is Test {
    ...
    function testWithdrawWithRebasePartialWithdraw() public {
        ...
        assertEq(asset.balanceOf(alice), aliceInitialAssets - initialDeposit + redeemedAssets);
        assertEq(vault.totalAssets(), initialDeposit - redeemedAssets);
        assertEq(vault.maxWithdraw(alice), initialDeposit - tooMuchAssetsToRedeem);
    }
