...
//         uint256 expectedTvlFee = userInitialBalance0 -
//             userInitialBalance0.mulDiv(
//                 setup.vault.tvlFeeScaled() * delay,
//                 365 days * MAX_SCALED_PERCENTAGE
//             );

//         // Verify recipient received tokens
//         assertEq(
//             setup.token0.balanceOf(recipient),
//             recipientBalanceBefore0 +
//                 (userInitialBalance0 - expectedTvlFee).mulDiv(
//                     withdrawPercentage,
...
//                 feeCollectorBalanceBefore0
//         );
//         assertTrue(
//             setup.token1.balanceOf(setup.feeCollector) >
//                 feeCollectorBalanceBefore1
//         );
