...
// test deposit / withdraw / mint / redeem functions with performance fee
// test collecting performance fees manually
contract PerformanceFeeTest is SimpleVaultTestSetup {
// using Math for uint256;

// /* -----------------------TEST UPDATING PERFORMANCE FEE----------------------- */
// // todo
// /* -----------------------TEST MANUAL COLLECTION----------------------- */
// function testCollectFeesAsOwner() public {
//     uint256 fee = 100;
//     setPerformanceFeeBasisPoint(fee); // 1%
...
//     uint256 expectedFee = computePerformanceFees(
//         depositAmount,
//         fee,
//         duration
//     );
...
//     uint256 duration = 365 days;
//     uint256 expectedFee = computePerformanceFees(shares, fee, duration);
...
//     // performance fee must have been collected
//     assertEq(
...
//     uint256 duration = 365 days;
//     uint256 expectedFee = computePerformanceFees(mintAmount, fee, duration);
